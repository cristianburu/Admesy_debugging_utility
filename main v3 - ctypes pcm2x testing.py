...
read_data = ctypes.create_string_buffer (bytecount)
error_read = py_usbtmc_read (ptr_handle, read_data, bytecount, timeout_ms)
autorange_params_read = read_data.value.decode("utf-8")
print (type(read_data.value))
print (f"Autorange parameters read are {autorange_params_read}")
